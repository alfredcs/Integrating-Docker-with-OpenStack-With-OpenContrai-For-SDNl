...
[[ `rpm -qa | egrep 'keepalived|haproxy|net-snmp-agent-libs'|wc -l` -gt 0 ]] && rpm -e --nodeps `rpm -qa|egrep 'haproxy|keepalived|net-snmp-agent-libs'`
[[ `rpm -qa| egrep net-snmp-agent-libs|wc -l` -lt 1 ]] && yum -y install net-snmp-agent-libs
